<?php
    /*
        Template Name: Threat Bulletin Category
    */
    get_header();
    $queried_object = get_queried_object();
    $category_name = $queried_object->name; // Get current category name
    $category_id = $queried_object->term_id; // Get current category ID
?>
        ...
        <div class="full-wrapper">
            ...
            <div class="banner-details">
                <div class="inner-wrapper">
                    <?php if($ib_tagline): ?>
                        <h1 class="h-80 sub fade-up"><?php echo esc_html($ib_tagline); ?></h1>
                    <?php endif; ?>
                    <h2 class="h-120 fw-5 main fade-up"><?php echo esc_html($category_name); ?></h2> <!-- Dynamic Category Name -->
                    <?php if($ib_content): ?>
            ...
            <div class="threat-wrapper">
                <div class="threats-landing-slider">
                    ...
                    ?>
                            <button type="button" class="threat-item fade-up">
                                <div class="detail-div">
                                    <h6 class="p-25 sub"><?php echo esc_html($tbi_sub_title); ?></h6>
                                    <h3 class="title h-30"><?php echo esc_html($tb_title); ?></h3>
                                    <p class="p-20 tb-date"><?php echo esc_html($tb_date); ?></p>
                                </div>
                                <a href="<?php echo esc_url($tbi_link); ?>" class="common-btn-trans btn-tb">
                                    <div class="btn-wrap">
                                        <div class="ar-icon">
                                            <svg class="left">
                    ...
                    <?php
                        ...
                        echo '<p>No announcements found in this category.</p>';
                    endif;
                    ?>
                </div>
